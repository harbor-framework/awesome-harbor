...
- [Meta-Harness](https://github.com/stanford-iris-lab/meta-harness-tbench2-artifact) - Outer-loop system that searches over harness code for LLM agents using prior scores and traces
