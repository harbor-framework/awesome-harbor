...
- [Meta-Harness](https://github.com/stanford-iris-lab/meta-harness-tbench2-artifact) - Agent that pre-bootstraps the sandbox environment to reduce exploration overhead
